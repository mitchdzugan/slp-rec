...
var rchainP = function (p) {
    return map(Data_Function.flip(foldl(function (acc) {
        return function (f) {
            return f(acc);
        };
    })))(Parsing_Combinators.many(p));
};
...
var lchainP = function (p) {
    return map(map1(Data_Function.flip(foldl(function (acc) {
        return function (f) {
            return f(acc);
        };
    })))(Data_List.reverse))(Parsing_Combinators.many(p));
};
...
var buildExprParser = function (operators) {
    return function (simpleExpr) {
        return foldl1(makeParser)(simpleExpr)(operators);
    };
};
export {
    AssocNone,
